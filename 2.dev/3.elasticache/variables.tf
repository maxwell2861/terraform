...
locals {
  ...
  network_info = {
    ...
    cache_subnet_group = data.terraform_remote_state.network.outputs.dev_cache_subnet_group
    db_sg              = data.terraform_remote_state.network.outputs.dev_rds_sg
    redis_sg           = data.terraform_remote_state.network.outputs.dev_redis_sg
  }
